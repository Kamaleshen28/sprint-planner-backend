...
// Path: test/services/project.test.js
// const projectServices = require('../../src/services/projects');
// const projectUtils = require('../../src/utils/projects');

describe('Project Services', () => {
  describe('createProject', () => {
    it('should return a project if projectUtils.calculateSprint returns a project', async () => {
      const mockData = {
        title: 'Test Project',
        sprintDuration: 2,
        stories: [],
      ...
      const mockResult = { id: 1, title: 'Test Project' };
      jest.spyOn(projectUtils, 'calculateSprint').mockReturnValue(mockResult);
      const result = await projectServices.createProject(mockData);
